...
public class ShimmerViewHelper {
	...
	private static final int DEFAULT_REFLECTION_COLOR = 0xffff0000;
	...
	private void resetLinearGradient() {
		...
		// our gradient is a simple linear gradient from textColor to reflectionColor. its axis is at
		// the center
		// when it's outside of the view, the outer color (textColor) will be repeated
		...
		linearGradient =
            ...
            0,
            new int[] {
				primaryColor, reflectionColor, primaryColor,
            },
            new float[] {0, 0.5f, 1},
            Shader.TileMode.CLAMP);
