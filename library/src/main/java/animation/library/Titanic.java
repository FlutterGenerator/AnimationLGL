...
public class Titanic {
	...
	public void start(final TitanicTextView textView) {
		...
		final Runnable animate =
			...
			public void run() {
				...
				maskXAnimator.setDuration(
					setDuration); // So it does not repeat too often. You may need to increase value
				// above too
		...
		if (!textView.isSetUp()) {
			textView.setAnimationSetupCallback(
				new AnimationSetupCallback() {
					@Override
	...
	public void start(final TitanicButton Button) {
		...
		if (!Button.isSetUp()) {
			Button.setAnimationSetupCallback(
				new AnimationSetupCallback() {
					@Override
					public void onSetupAnimation(final TitanicTextView target) {}
